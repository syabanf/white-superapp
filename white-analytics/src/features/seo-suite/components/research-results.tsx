...
export function ResearchResults({
  ...
  const rows = React.useMemo<Row[]>(
    () =>
      filterIdeas(ideas, filters).map((i) => ({ ...i, tracked: trackedSet.has(i.keyword.toLowerCase()) })),
    [ideas, filters, trackedSet],
  );
  ...
  const columns: ColumnDef<Row, unknown>[] = [
      ...
      ? [
          {
            ...
            cell: ({ row }) =>
              row.original.tracked ? (
                ...
                <Checkbox
                  aria-label={row.original.keyword}
                  checked={selected.has(row.original.keyword)}
                  onCheckedChange={(v) => toggle(row.original.keyword, Boolean(v))}
                />
              ),
    ...
    },
    {
      ...
      header: s.trend12,
      enableSorting: false,
      cell: ({ row }) => <TrendCell values={row.original.trend} />,
    },
    {
    ...
    },
    {
      ...
      header: s.cpc,
      meta: right,
      cell: ({ row }) => <span className="tabular">{formatCurrency(row.original.cpc, "IDR")}</span>,
    },
    {
      accessorKey: "intent",
      header: s.intent,
    ...
    },
    {
      ...
      enableSorting: false,
      cell: ({ row }) => <SerpFeatureChips features={row.original.serpFeatures} />,
    },
  ];
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                value={filters.maxKd}
                onChange={(e) =>
                  setFilters({ ...filters, maxKd: Math.min(100, Math.max(0, Number(e.target.value) || 0)) })
                }
              />
            </div>
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={(v) => setFilters({ ...filters, intent: v as IdeaFilters["intent"] })}
              >
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder={s.filterPlaceholderInclude}
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder={s.filterPlaceholderExclude}
